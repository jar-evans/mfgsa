...
title('Total SI MSE for mech. oscillator - 1FHF','interpreter','latex')
...
legend(flipud(findall(gca,'Tag','Box')), {'MC', 'PCE', 'KLPC'},...
    'Location','NorthEast','interpreter','latex'); legend boxoff
bp = gca;   bp.XAxis.TickLabelInterpreter = 'latex';
title('Main SI MSE for mech. oscillator - 1FHF','interpreter','latex')
xlabel('Budget (model evaluations)'); ylabel('MSE'); hold off;
...
legend(flipud(findall(gca,'Tag','Box')), {'p = 100', 'p = 1000', 'p = 10000'},...
    'Location','NorthEast','interpreter','latex'); legend boxoff
bp = gca;   bp.XAxis.TickLabelInterpreter = 'latex';
title('Total SI spread for mech. oscillator - 1FHF - MC','interpreter','latex')
...
legend(flipud(findall(gca,'Tag','Box')), {'p = 100', 'p = 1000', 'p = 10000'},...
    'Location','NorthEast','interpreter','latex'); legend boxoff
bp = gca;   bp.XAxis.TickLabelInterpreter = 'latex';
title('Total SI spread for mech. oscillator - 1FHF - KLPC','interpreter','latex')
% end
