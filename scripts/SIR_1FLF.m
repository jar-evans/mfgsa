...
fcns{1} = @(I) f_cholera(I, 0:dt:T, 2, 45);   % high-fidelity
...
title('Total SI MSE for SIR - 1FLF','interpreter','latex')
...
legend(flipud(findall(gca,'Tag','Box')), {'MC', 'PCE', 'KLPC'},...
    'Location','NorthEast','interpreter','latex'); legend boxoff
bp = gca;   bp.XAxis.TickLabelInterpreter = 'latex';
title('Main SI MSE for SIR - 1FLF','interpreter','latex')
xlabel('Budget (model evaluations)'); ylabel('MSE'); ylim([9e-3, 2]); hold off;
...
legend(flipud(findall(gca,'Tag','Box')), {'p = 250', 'p = 1000'},...
    'Location','NorthEast','interpreter','latex'); legend boxoff
bp = gca;   bp.XAxis.TickLabelInterpreter = 'latex';
title('Total SI spread for SIR - 1FLF - MC','interpreter','latex')
...
legend(flipud(findall(gca,'Tag','Box')), {'p = 250', 'p = 1000'},...
    'Location','NorthEast','interpreter','latex'); legend boxoff
bp = gca;   bp.XAxis.TickLabelInterpreter = 'latex';
title('Main SI spread for SIR - 1FLF - MC','interpreter','latex')
...
bp = gca;   bp.XAxis.TickLabelInterpreter = 'latex';
title('Total SI spread for SIR - 1FLF - PCE','interpreter','latex')
...
bp = gca;   bp.XAxis.TickLabelInterpreter = 'latex';
title('Main SI spread for SIR - 1FLF - PCE','interpreter','latex')
...
legend(flipud(findall(gca,'Tag','Box')), {'p = 10', 'p = 250'},...
    'Location','NorthWest','interpreter','latex'); legend boxoff
bp = gca;   bp.XAxis.TickLabelInterpreter = 'latex';
title('Total SI spread for SIR - 1FLF - KLPC','interpreter','latex')
...
legend(flipud(findall(gca,'Tag','Box')), {'p = 10', 'p = 250'},...
    'Location','NorthWest','interpreter','latex'); legend boxoff
bp = gca;   bp.XAxis.TickLabelInterpreter = 'latex';
title('Main SI spread for SIR - 1FLF - KLPC','interpreter','latex')
